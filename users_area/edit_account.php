...
if(isset($_GET['edit_account'])){
    ...
    $username=$row_fetch['username'];  //this username is which is present inside the bracket is from database.
    ...
    if(isset($_POST['user_update'])){
        $update_id=$user_id;
        $username=$_POST['user_username'];   //this username is which is present inside the bracket is from name attribute.
