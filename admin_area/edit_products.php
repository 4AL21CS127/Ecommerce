...
if(isset($_GET['edit_products'])){
    ...
    $get_data="Select * from `products` where product_id= $edit_id";  //if this id is not present inside the database,then we are not going to fetch any data.
    $result=mysqli_query($con,$get_data);
    $row=mysqli_fetch_assoc($result); //here we are fetching only one data therefore we are not including this in the while.
    ...
    //first we are going to going compare the category id of products table and category id of categories table ,we cant directly select category_title why because inside the products table we have not stored the category_title,then from categories table we are going to access category_name.
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <label for="product_category" class="form-label">Product Categories</label>
            <select name="product_category" class="form-select">
                ...
                <?php
                        $select_category_all="Select * from `categories`" ;  //here I am removing where condition because I have to fetch all the details of category
        ...
        <label for="product_brands" class="form-label">Product Brands</label>
            <select name="product_brands" class="form-select">
                ...
                <?php
                        $select_brand_all="Select * from `brands`" ;  //here I am removing where condition because I have to fetch all the details of category
        ...
        <div class="d-flex">
            <input type="file" class="form-control w-90 " name="product_image1" id="product_image1" >
        ...
        <div class="d-flex">
            <input type="file" class="form-control w-90 " name="product_image2" id="product_image2" >
        ...
        <div class="d-flex">
            <input type="file" class="form-control w-90 " name="product_image3" id="product_image3" >
...
if(isset($_POST['edit_product'])){
    ...
    if($product_title=='' or  $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price=='' ){
        ...
        //if my query is executed successfully
        if($result_update){
            echo "<script>alert('Producted updated successfully')</script>"; 
